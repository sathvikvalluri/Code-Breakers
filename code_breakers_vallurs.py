...
def save_game(files, date_time, grid, passcode, red_pins, white_pins, chance):
...
def play_game(files, date_time, passcode, grid, red_pins, white_pins, chance):
    guess = 0
    file_choice = 0
    ...
    while chance < 10:
        ...
        while True:
            ...
            if guess == 'q' or guess =='Q':
                ...
                file_choice, files, date_time = save_game(files, date_time, grid, passcode, red_pins, white_pins, chance)
                break
            elif guess == passcode:
                chance += 1
                break
...
def main():
    ...
    while True:
        ...
        if choice == '1':
            ...
            files, date_time = play_game(files, date_time, passcode, grid, red_pins, white_pins, chance)
        elif choice == '3':
            file_name = ['first_game', 'second_game', 'third_game']
            print('Files:')
            for i in range(3):
